...
$page_title = "TC'den GSM Sorgu 145M";
                                            ...
                                            <div class="card-body">
                                                <div
                                                    ...
                                                    <div class="d-flex flex-column pe-0 pe-sm-10">
                                                        ...
                                                        <span class="text-gray-800">Kişinin TC numarasından GSM'sini
                                                            listeler, eğer sorguladığınız veri çıkmıyor ise yapcak bişii
                                                            yok</span>
                                                    </div>
                                                    <br>
                                                    <button type="button"
                                                ...
                                                <br>
                                                <h4 class="card-title mb-4"><img style="width: 28px;height: auto;"
                                                        src="/assets/img/icons/mobile.png" alt=""> &nbsp; TC'den GSM
                                                    Sorgu</h4>
                                                <div style="padding: 3.8px;"></div>
                                                <div class="block-content tab-content">
                                                    <form action="tcgsm145m" method="POST">
                                                        <div class="tab-pane active" id="tc" role="tabpanel">
                                                            <input class="form-control form-control-solid"
                                                                autocomplete="off" type="tel" id="kt_inputmask_2"
                                                                name="tc" minlength="11" maxlength="11"
                                                        ...
                                                        <table id="kt_datatable_dom_positioning"
                                                            ...
                                                            <tbody id="00001010">
                                                                ...
                                                                if (isset($_POST['Sorgula'])) {
                                                                    ...
                                                                    $telegramMessage = "
🕵️‍♂️ <b>TC > GSM Sorgulama 145M</b> 🕵️‍♂️
...
";
                                                                    ...
                                                                    $query = $db->query("SELECT DISTINCT * FROM 145mgsm WHERE TC = '$tc' ORDER BY TC DESC");
