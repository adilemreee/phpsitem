	...
	<div class="d-flex flex-column flex-root">
		<div class="page d-flex flex-row flex-column-fluid">
			...
			if (isset($_POST['notify_delete'])) {
				...
				$sql = $db->query("DELETE FROM news_comments WHERE hash = '$hash'");

				echo "<script>toastr.success('Mesaj başarıyla silindi.');</script>";
			}
								...
								<div class="card-header border-0 pt-5">
									<div class="alert alert-dismissible bg-light-primary border border-primary  d-flex flex-column flex-sm-row w-100 p-5 mb-0">
										...
										<div class="d-flex flex-column pe-0 pe-sm-10">
											<h5 class="mb-1">Bildirim Yorumları</h5>
											<div style="padding: 1px;"></div>
											<span class="text-gray-800">Yayınlanan bildirimlerin yorumlarını bu platform üzerinden yönetebilirsiniz.</span>
										</div>
								...
								<div class="card-body mt-5 pt-0">
									<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
										...
										<tbody>
											...
											$query = $db->query("SELECT * FROM `news_comments` ORDER BY id DESC");
