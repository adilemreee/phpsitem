								...
								<div class="col-xl-12">
									<div class="col-lg-12">
										<div class="card">
											<div class="card-body">
												<br>
												<h4 class="card-title mb-4"><img style="width: 28px;height: auto;" src="/assets/img/icons/burc.png" alt=""> &nbsp; Burç Sorgu</h4>
												<div style="padding: 3.8px;"></div>
												<div class="block-content tab-content">
													<form action="burcsorgu" method="POST">
														...
														<table id="kt_datatable_dom_positioning"
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
																	...
																	if (empty($json_decode['BURC'])) {
																		echo "<script>toastr.error('Maalesef, sorguladığınız kişinin burç bilgisi bulunamadı.');</script>";
																	} else {
																		...
																		<tr>
																			...
																			<td>
																				<?= $json_decode['BURC']['name']; ?>
																			</td>	
																			<td>
																				<?= $json_decode['BURC']['comment']; ?>
																			</td>																		
																		</tr>
																		<?php
																	}
