										...
										<div class="card">
											<div class="card-body">
												...
												<div class="block-content tab-content">
													<form action="dnschecker" method="POST">
														<div class="tab-pane active" id="tc" role="tabpanel">
															<input class="form-control form-control-solid"
																autocomplete="off" type="text" name="domain"
														...
														<table id="kt_datatable_dom_positioning"
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
																	...
																	echo "<script>toastr.info('DNS bilgileri getirildi.');</script>";
																	echo "<script>toastr.success('Sorgu işlemi başarıyla tamamlandı.');</script>";

																	$domain = htmlspecialchars(strip_tags($_POST['domain']));

																	// Nameserverlar için DNS kaydını çek
																	$nameservers = dns_get_record($domain, DNS_NS);

																	// Her bir nameserver'ın IP adresini, türünü, TTL değerini ve SSL durumunu yazdır
																	foreach ($nameservers as $ns) {
																		echo "<tr><th>" . $domain . "</th>";
																		echo "<th>" . $ns['target'] . "</th>";
																		echo "<th>" . gethostbyname($ns['target']) . "</th>";
																		echo "<th>" . $ns['type'] . "</th>";
																		echo "<th>" . $ns['ttl'] . "</th>";
																	}
																}
