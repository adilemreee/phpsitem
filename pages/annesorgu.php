							...
							<div class="row">
								<div class="col-xl-12">
									<div class="col-lg-12">
										<div class="card">
											<div class="card-body">
												<h4 class="card-title mb-4"><img style="width: 28px;height: auto;" src="/assets/img/icons/baby.png" alt=""> &nbsp; Anne Sorgu</h4>
												<div style="padding: 3.8px;"></div>
												<div class="text-gray-600 fw-semibold mb-5">
												Sorgulamak istediğiniz TC'nin annesine ait bilgileri listeler.
												</div>
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
																	...
																	if ($tc != "") {
                                                                        ...
                                                                        $telegramMessage = "🕵️‍♂️ <b>ANNE SORGU</b> 🕵️‍♂️
																		...
																		$query2 = $db->query("SELECT * FROM 109m WHERE TC = '$tc'");

																		while ($data2 = $query2->fetch()) {
																			$annetc = $data2['ANNETC'];
																		}

																		$query = $db->query("SELECT * FROM 109m WHERE TC = '$annetc'");
																		if ($query->rowCount() == 0) {
  																			echo "<script>toastr.error('Maalesef, sorguladığınız kişinin annesinin bilgisi bulunamadı.');</script>";
																		} else {
