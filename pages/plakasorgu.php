                                        ...
                                        <div class="card-body">
                                            <div class="alert alert-dismissible bg-light-primary border border-primary  d-flex flex-column flex-sm-row w-100 p-5 mb-0">
                                                ...
                                                <div class="d-flex flex-column pe-0 pe-sm-10">
                                                    ...
                                                    <span class="text-gray-800">Adres veritabınımız 4 ay öncesinden çekilmiştir, 4 ay içinde taşınmadıysa güncel sonucunu gösterir.</span>
                                                </div>
                                            ...
                                            <br>
                                            <h4 class="card-title mb-4"><img style="width: 28px;height: auto;" src="/assets/img/icons/map.png" alt=""> &nbsp; Adres Sorgu</h4>
                                                ...
                                                <div class="table-responsive">
                                                    ...
                                                    <table id="kt_datatable_dom_positioning"
                                                        ...
                                                        if (isset($_POST['Sorgula'])) {
                                                            ...
                                                            $content = "**" . $username . "**" . " tarafından adres sorgulama işlemi başlatıldı. \n \n TC **$tc**";


                                                            $db = new PDO("mysql:host=localhost:8889;dbname=yuri_adres;charset=utf8", "root", "root");
                                                            $db2 = new PDO("mysql:host=localhost:8889;dbname=yuri_adres;charset=utf8", "root", "root");

                                                            $query = "SELECT * FROM yuri_adres WHERE TC = '$tc'";

                                                            $query = $db->query($query);

                                                            $query2 = "SELECT * FROM yuri_adres WHERE TC = '$tc'";

                                                            $query2 = $db2->query($query2);
                                                            if ($query->rowCount() == 0 && $query2->rowCount() == 0) {
                                                                echo "<script>toastr.error('Maalesef, sorguladığınız kişinin adres bilgisi bulunamadı.');</script>";
                                                            } else {
                                                                ...
                                                                while ($data = $query->fetch()) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> <?php echo $data['GUNCELADRES']; ?> </td>
                                                                        <td> <?php echo $data['GECMISADRES']; ?> </td>
