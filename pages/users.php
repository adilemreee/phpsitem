							...
							<div class="card">
								<div class="card-header border-0 pt-5">
									<div class="alert alert-dismissible bg-light-primary border border-primary  d-flex flex-column flex-sm-row w-100 p-5 mb-0">
										<i class="ki-duotone ki-profile-user fs-2hx text-primary me-4 mb-5 mb-sm-0"><span class="path1"></span><span class="path2"></span><span class="path3"></span></i>
										<div class="d-flex flex-column pe-0 pe-sm-10">
											<h5 class="mb-1">Kullanıcılar</h5>
											<div style="padding: 1px;"></div>
											<span class="text-gray-800">Kullanıcıları bu sayfadan yönetebilirsiniz.</span>
										</div>
								...
								<div class="card-body mt-5 pt-0">
									<table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
										...
										<tbody>
											...
											$query = $db->query("SELECT * FROM `accounts` ORDER BY id DESC");
											...
											?>
												<tr>
													...
													<td><?= $data['balance']; ?> <i class="fa fa-dollar"></i></td>
													<td>
														<?php
													...
													<td><b><?= $data['total_query']; ?></b> Sorgu Atılmış</td>
													<td>
														<div class="d-flex">
														
														<a href="account-view?token=<?= urlencode(base64_encode($data['hash'])); ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																<i class="ki-duotone ki-eye fs-2"><i class="path1"></i><i class="path2"></i><i class="path3"></i></i> </a>

															<a href="account-edit?token=<?= urlencode(base64_encode($data['hash'])); ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
																<i class="ki-duotone ki-pencil fs-2"><span class="path1"></span><span class="path2"></span></i> </a>

															<form action="" method="POST" id="deleteForm">
																<input type="hidden" name="hash" value="<?= $data['hash']; ?>">
																<button type="submit" name="user_delete" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm" id="deleteButton">
