							...
							<div class="row">
								<div class="col-xl-12">
									<div class="col-lg-12">
										<div class="card">
											<div class="card-body">
												<h4 class="card-title mb-4"> Anne Tarafı Aile Sorgu</h4>
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
																	...
																	if ($tc != "") {
                                                                        ...
                                                                        $telegramMessage = "🕵️‍♂️ <b>ANNE TARAFI SORGU</b> 🕵️‍♂️
																		...
																		if (mysqli_num_rows($result) == 0) {
																			echo "<script>toastr.error('Maalesef, sorguladığınız kişinin Anne tarafı bilgisi bulunamadı.');</script>";
																			} else {
