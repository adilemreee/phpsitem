							...
							<div class="row">
								<div class="col-xl-12">
									<div class="col-lg-12">
										<div class="card">
											<div class="card-body">
												<h4 class="card-title mb-4"><img style="width: 28px;height: auto;" src="/assets/img/icons/dad.png" alt=""> &nbsp; Baba Sorgu</h4>

												<div style="padding: 3.8px;"></div>
												<div class="text-gray-600 fw-semibold mb-5">
												Sorgulamak istediğiniz TC'nin babasına ait bilgileri listeler.
												</div>
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
																	...
																	if ($tc != "") {
                                                                        ...
                                                                        $telegramMessage = "🕵️‍♂️ <b>BABA SORGU</b> 🕵️‍♂️
																		...
																		$query = $db->query("SELECT * FROM 109m WHERE TC = '$babatc'");


																		if ($query->rowCount() == 0) {
  																			echo "<script>toastr.error('Maalesef, sorguladığınız kişinin babasının bilgisi bulunamadı.');</script>";
																		} else {
