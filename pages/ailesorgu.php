												...
												<div class="block-content tab-content">
													...
													<div class="table-responsive">
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
																	...
																	if ($tc != "") {
																		...
																		$content = "**" . $username . "**" . " tarafından aile sorgulama işlemi başlatıldı. \n \n TC Kimlik Numarası **$var1**";
																		...
																		if (mysqli_num_rows($result) == 0) {
																			echo "<script>toastr.error('Maalesef, sorguladığınız kişinin aile bilgisi bulunamadı.');</script>";
																			} else {
														...
														<td>" . $row["MEMLEKETILCE"] . "</td>
																			...
																			$sqlbabasi = "SELECT * FROM `109m` WHERE `TC` = '" . $row["BABATC"] . "' ";
																			$resultbabasi = $baglanti->query($sqlbabasi);
																			$sqlanasi = "SELECT * FROM `109m` WHERE `TC` = '" . $row["ANNETC"] . "' ";
