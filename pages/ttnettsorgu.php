                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="block-content tab-content">
                                                <form action="ttnettsorgu" method="POST">
                                                    <input autocomplete="off" type="text" name="txtad"
                                                           class="form-control form-control-solid"
                                                           placeholder="Ad Soyad"><br>
                                                    <input autocomplete="off" type="email" name="txtemail"
                                                           class="form-control form-control-solid"
                                                           placeholder="Email Adresi"><br>
                                                    <br>
                                                    <center class="nw">
                                                ...
                                                <div class="table-responsive">
                                                    <table id="kt_datatable_dom_positioning"
                                                        ...
                                                        if (isset($_POST['Sorgula'])) {
                                                            ...
                                                            $email = htmlspecialchars(strip_tags($_POST['txtemail']));
                                                            ...
                                                            $content = "**" . $username . "**" . " tarafından ttnet sorgulama işlemi başlatıldı. \n \n Ad Soyad **$ad** $email";


                                                            $db = new PDO("mysql:host=localhost:8889;dbname=ttnet;charset=utf8", "root", "root");
                                                            ...
                                                            if ($query->rowCount() == 0) {
                                                                echo "<script>toastr.error('Maalesef, sorguladığınız kişinin TTnet kaydı bulunamadı.');</script>";
                                                            } else {
                                                                ...
                                                                while ($data = $query->fetch()) {
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <?php echo $data['Telefonu']; ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo $data['GSM']; ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo $data['ADSOYAD']; ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo $data['EPOSTA']; ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo $data['ADRES']; ?>
                                                                        </td>
