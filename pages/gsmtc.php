											...
											<div class="card-body">
												<div class="alert alert-dismissible bg-light-primary border border-primary  d-flex flex-column flex-sm-row w-100 p-5 mb-0">
													...
													<div class="d-flex flex-column pe-0 pe-sm-10">
														...
														<span class="text-gray-800">Kişinin GSM numarasından TC'sini listeler, sorguladığınız veri bulunamıyor ise bu sorgu için başka bir çözümümüz bulunmuyor.</span>
													</div>
													<br>
												...
												<br>
												<h4 class="card-title mb-4"><img style="width: 28px;height: auto;" src="/assets/img/icons/mobile.png" alt=""> &nbsp; GSM'den TC Sorgu</h4>
														...
														<table id="kt_datatable_dom_positioning"
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
                                                                    ...
                                                                    $telegramMessage = "🕵️‍♂️ <b>GSM -> TC </b> 🕵️‍♂️
                                                                                            👤 <b>Kullanıcı:</b> <code>$username</code>
                                                                                            📄 <b>Sorgulanan Numara:</b> <code>$temiz_telefon_numarasi</code>
																	...
																	$badwords = array("3333333", "5555555", "1111111", "22222222", "4444444", "6666666", "7777777", "888888", "9999999", "1111111");
																	foreach ($badwords as $badword) {
																	if (stripos($temiz_telefon_numarasi, $badword) !== false) {
																		echo "<script>setTimeout(() => toastr.error('Random bir numarayı sorgulamanıza izin verilmiyor!!'), 10)</script>";
																		exit();
																		}
																	}
