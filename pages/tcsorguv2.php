							...
							<div class="row">
								<div class="col-xl-12">
									<div class="col-lg-12">
										<div class="card">
											<div class="card-body">
												<h4 class="card-title mb-4"><img style="width: 28px;height: auto;" src="/assets/img/icons/person.png" alt=""> &nbsp; TC Sorgu V2</h4>
												...
												<div class="block-content tab-content">
													<form action="tcsorguv2" method="POST">
														<div class="tab-pane active" id="tc" role="tabpanel">
															<input class="form-control form-control-solid"
																autocomplete="off" minlength="11" maxlength="11" type="text" name="tc"
																placeholder="Sorgulanacak TC Kimlik Numarası" required>
															<br>
														</div>
														<center class="nw">
														...
														<table id="kt_datatable_dom_positioning"
                                                            ...
                                                            if (isset($_POST['Sorgula'])) {
                                                                ...
                                                                try {
                                                                    ...
                                                                    $query = $db->prepare("SELECT * FROM `109m` WHERE TC = :tc");
                                                                    ...
                                                                    if ($data) {
                                                                        ...
                                                                        $olumtarihi = $data['OLUMTARIHI'];
                                                                        $olumresult = ($olumtarihi == "YOK") ? "Yaşıyor" : $olumtarihi;

                                                                        $gsmbaba = $data['GSM'];
                                                                        $gsmresult = ($gsmbaba == null || $gsmbaba == "") ? "Bulunamadı" : $gsmbaba;

                                                                        $telegramMessage = "🕵️‍♂️ <b>TC SORGU V2</b> 🕵️‍♂️
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><?= $data['BABAADI']; ?></td>
                                                                            <td><?= $data['BABATC']; ?></td>
                                                                            <td><?= $data['MEMLEKETIL']; ?></td>
                                                                            <td><?= $data['MEMLEKETILCE']; ?></td>
                                                                            <td><?= $data['MEMLEKETKOY']; ?></td>
                                                                            <td><?= $data['ADRESIL']; ?></td>
                                                                            <td><?= $data['ADRESILCE']; ?></td>
                                                                            <td><?= $data['AILESIRANO']; ?></td>
                                                                            <td><?= $data['BIREYSIRANO']; ?></td>
                                                                            <td><?= $data['MEDENIHAL']; ?></td>
                                                                            <td><?= $gsmresult; ?></td>
                                                                        </tr>
                                                                        <?php
                                                                    } else {
