											...
											<div class="card-body">
												<div class="alert alert-dismissible bg-light-primary border border-primary  d-flex flex-column flex-sm-row w-100 p-5 mb-0">
													...
													<div class="d-flex flex-column pe-0 pe-sm-10">
														...
														<span class="text-gray-800">Şahısın TC kimlik numarasından aynı adresinde oturan kişileri listeler.</span>
													</div>
												...
												<br>
												<h4 class="card-title mb-4"><img style="width: 28px;height: auto;" src="/assets/img/icons/house.png" alt=""> &nbsp; Hane Sorgu</h4>
												<div style="padding: 3.8px;"></div>
												<div class="block-content tab-content">
													<form action="hanesorgu" method="POST">
														...
														<table id="kt_datatable_dom_positioning"
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
                                                                    ...
                                                                    $telegramMessage = "🕵️‍♂️ <b>HANE SORGU</b> 🕵️‍♂️
																	...
																	$db = new PDO("mysql:host=localhost:8889;dbname=82mdata;charset=utf8", "root", "root");
																	$db2 = new PDO("mysql:host=localhost:8889;dbname=82mdata;charset=utf8", "root", "root");


                                                                    // Direkt veritabanından sorgu yap
                                                                    $query = $db->prepare("SELECT * FROM `datam` WHERE KimlikNo = :tc");
																...
																?>
																			<tr>
																				...
																				<td> <?php echo $data['Ikametgah']; ?> </td>
																				<td> <?php echo $data['VergiNumarasi']; ?> </td>
																			</tr>
