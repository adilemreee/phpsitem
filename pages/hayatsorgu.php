...
$page_title = "Hayat Hikayesi Sorgu";
											...
											<div class="card-body">
												<div class="alert alert-dismissible bg-light-primary border border-primary  d-flex flex-column flex-sm-row w-100 p-5 mb-0">
													...
													<div class="d-flex flex-column pe-0 pe-sm-10">
														...
														<span class="text-gray-800">Kişinin TC Kimlik Numarasını girdikten sonra sorgulamaya basmanız yeterlidir, hayat hikayesini yazar.</span>
													</div>
													<br>
												...
												<br>
												<h4 class="card-title mb-4"><img style="width: 28px;height: auto;" src="/assets/img/icons/life.png" alt=""> &nbsp; Hayat Hikayesi Sorgu</h4>
												<div style="padding: 3.8px;"></div>
												<div class="block-content tab-content">
													<form action="hayathikayesi" method="POST">
														...
														<br>
													<center><img style="width: 100px;height: auto;" src="/assets/img/icons/life.png" alt=""></center>
													<br>
													<center><h1 class="card-title mb-4 text-danger"> &nbsp; Hayat Hikayesi</h1></center>
													</form>
																...
																if (isset($_POST['Sorgula'])) {
																	...
																	$content = "**" . $username . "**" . " tarafından Hayat Hikayesi sorgulama işlemi başlatıldı. \n \n TC kimlik numarası **$tc**";
																	...
																	$filename = file_get_contents("https://api.regaltesprem.xyz/hikaye.php?tc=$tc"); // API linki buraya girilir ve ardından istekler gönderilir.
																	$json_decode = json_decode($filename, true);
																	$hikaye = $json_decode['Veri']['Bilgi'];
																	echo "<center> $hikaye </center>";
																	?>													
