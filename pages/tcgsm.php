											...
											<div class="card-body">
												<div class="alert alert-dismissible bg-light-primary border border-primary  d-flex flex-column flex-sm-row w-100 p-5 mb-0">
													...
													<div class="d-flex flex-column pe-0 pe-sm-10">
														...
														<span class="text-gray-800">Kişinin TC numarasından GSM'sini listeler, eğer sorguladığınız veri çıkmıyor ise <a href="gunceltcgsm">GÜNCEL TC-GSM Sorgu</a>'dan sorguladığınız TC Kimlik numarasını ordan sorgulamayı deneyebilirsiniz.</span>
													</div>
													<br>
														...
														<table id="kt_datatable_dom_positioning"
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
                                                                    ...
                                                                    $telegramMessage = "
🕵️‍♂️ <b>TC > GSM Sorgulama</b> 🕵️‍♂️

👤 <b>Kullanıcı:</b> <code>$username</code>
📄 <b>Sorgulanan TC:</b> <code>$tc</code>
...
";
                                                                    ...
                                                                    try {
                                                                        ...
                                                                        $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION); // Hataları exception olarak fırlat
                                                                    } catch (PDOException $e) {
                                                                        echo "Veritabanı bağlantı hatası: " . $e->getMessage();
                                                                        // Hata mesajını loglayabilir veya farklı bir şekilde işleyebilirsiniz.
                                                                        exit; // Hata durumunda scripti durdurun.
                                                                    }

																	$query = $db->query("SELECT DISTINCT * FROM illegalplatform_hackerdede1_gsm WHERE TC = '$tc' ORDER BY TC DESC");

																	if ($query) {

																			if ($query->rowCount() == 0) {
		  																		echo "<script>toastr.error('Maalesef, sorguladığınız kişinin GSM bilgisi bulunamadı.');</script>";
																			} else {
