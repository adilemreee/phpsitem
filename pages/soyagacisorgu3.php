<?php
// NOT: Timeout ve memory limit ayarları MAMP php.ini'den yapılmalı:
...
<head>
    ...
    <!-- JS Fonksiyonları - PHP çalışmadan önce yüklenir -->
    <script>
        function clearTable() {
        ...
        function copyTable() {
            ...
            if (typeof toastr !== 'undefined') {
                ...
                alert('Tablo içeriği panoya kopyalandı.');
            }
        }
...
<body id="kt_body" class="aside-enabled">
    ...
    <!-- JS fonksiyonları artık head'de tanımlı -->
    ...
    <!-- DataTables Initialization - Tüm scriptler yüklendikten sonra çalışır -->
    <script>
        $(document).ready(function () {
            // Tablo varsa DataTables başlat
            if ($('#kt_datatable_dom_positioning').length === 0) {
                return;
            }
            ...
            var table = $('#kt_datatable_dom_positioning').DataTable({
                ...
                "dom": "<'row'<'col-sm-12 d-flex align-items-center justify-content-start'l><'col-sm-12 d-flex align-items-center justify-content-end'f>><'table-responsive'tr><'row'<'col-sm-12 col-md-5 d-flex align-items-center justify-content-start justify-content-md-start'i><'col-sm-12 col-md-7 d-flex align-items-center justify-content-start justify-content-md-end'p>>",
                "paging": false,
                "ordering": false,
                "info": false
            });
            ...
            // Butonları oluştur
            var buttonsContainer = new $.fn.dataTable.Buttons(table, {
                buttons: [
                    'excel',
                    {
                        extend: 'pdfHtml5',
            ...
            // Butonları ekle
            var targetWrapper = $('#kt_datatable_dom_positioning_wrapper .col-sm-12:eq(1)');
            if (targetWrapper.length === 0) {
                targetWrapper = $('#kt_datatable_dom_positioning').parent();
            }
            buttonsContainer.container().appendTo(targetWrapper);
