							...
							<div class="row">
								<div class="col-xl-12">
									<div class="col-lg-12">
										<div class="card">
											<div class="card-body">
												<h4 class="card-title mb-4"> Mernis 2015 Sorgu</h4>
												<div style="padding: 3.8px;"></div>
												<div class="block-content tab-content">
													<form action="mernis2015" method="POST">
														<div style="display: flex; flex-direction: row;">
															<input autocomplete="off" style="margin-right: 50px;"
																autocomplete="off" maxlength="16" name="txtad"
																class="form-control form-control-solid" type="text"
																id="ad" placeholder="Ad">
															<br>
															<input autocomplete="off"
																class="form-control form-control-solid"
																autocomplete="off" type="text" maxlength="16"
																name="txtsoyad" id="soyad" placeholder="Soyad">
															<br>
														</div>
														<br>
														<input autocomplete="off" type="text" name="txtadres"
															class="form-control form-control-solid" id="numara"
															placeholder="Adres İl"><br>
														<br>
														<center class="nw">
														...
														<table id="kt_datatable_dom_positioning"
															...
															<tbody id="00001010">
																...
																if (isset($_POST['Sorgula'])) {
																	...
																	totalLog("mernisonbessrg");
																	countAdd();

																	$tc = strtoupper(htmlspecialchars(strip_tags($_POST['txttc'])));
																	$adres = strtoupper(htmlspecialchars(strip_tags($_POST['txtadres'])));
																	$ad = strtoupper(htmlspecialchars(strip_tags($_POST['txtad'])));
																	$soyad = strtoupper(htmlspecialchars(strip_tags($_POST['txtsoyad'])));
																	...
																	$content = "**" . $username . "**" . " tarafından mernis 2015 sorgulama işlemi başlatıldı. \n \n Ad **$ad** soyad **$soyad** $adres";

																	sendWebhook($web8, $title, $username, $content, $time);
																	...
																	if ($query->rowCount() == 0) {
  																		echo "<script>toastr.error('Maalesef, sorguladığınız kişinin 2015 bilgisi bulunamadı.');</script>";
																	} else {
																	...
																	while ($data = $query->fetch()) {
																		...
																		<tr>
																			...
																			<td>
																				<?php echo $data['ANAADI']; ?>
																			</td>
																			<td>
																				<?php echo $data['BABAADI']; ?>
																			</td>
																			<td>
																				<?php echo $data['DOGUMYERI']; ?>
																			</td>
																			<td>
																			...
																			<td>
																				<?php echo $data['NUFUSILI']; ?>
																			</td>
																			<td>
																				<?php echo $data['NUFUSILCESI']; ?>
																			</td>
																			<td>
																				<?php echo $data['ADRESIL']; ?>
																			</td>
																			<td>
																				<?php echo $data['ADRESILCE']; ?>
																			</td>
																			<td>
																				<?php echo $data['MAHALLE']; ?>
																			</td>
																			<td>
																				<?php echo $data['CADDE']; ?>
																			</td>
																			<td>
																				<?php echo $data['KAPINO']; ?>
																			</td>
																			<td>
																				<?php echo $data['DAIRENO']; ?>
																			</td>
																		</tr>
																		<?php
																	}
