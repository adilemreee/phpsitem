                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="text-gray-600 fw-semibold mb-5">
                                                Burada Önemli Olan TC , TC yi al çık usta
                                            </div>
                                            <div class="block-content tab-content">
                                                <form action="detayliadsorgu" method="POST">
                                                    ...
                                                    <table id="kt_datatable_dom_positioning" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                                                        ...
                                                        if (isset($_POST['Sorgula'])) {
                                                            ...
                                                            if (empty($ad) || empty($soyad)) {
                                                                echo '<script>toastr.error("Lütfen ad ve soyad bilgilerini girin.");</script>';
                                                                exit;
                                                            }
                                                            ...
                                                            try {
                                                                ...
                                                                // **GÜNCELLENMİŞ** Hazırlanmış SQL sorgusu
                                                                $query = $db->prepare("SELECT TC, AD, SOYAD, DOGUMTARIHI,ANNEADI, BABAADI FROM 109m WHERE AD = :ad AND SOYAD = :soyad");
